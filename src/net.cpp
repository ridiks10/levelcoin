...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Levelcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"ec2-54-202-89-118.us-west-2.compute.amazonaws.com", "54.202.89.118"}, //s2
    {"ec2-54-200-158-196.us-west-2.compute.amazonaws.com", "54.202.89.118"}, //s1
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Levelcoin is probably already running."), addrBind.ToString().c_str());
        else
